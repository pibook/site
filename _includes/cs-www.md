...
<figcaption>Figure 1: Οι πρώτες σελίδες του WWW είχαν στόχο να
...
<figcaption>Figure 2: Το σύστημα Amaya παρέχει ολοκληρωμένη πρόβαση στον
παγκόσμιο ιστό, όχι μόνο ως φυλλομετρητής, αλλά, κυρίως, ως ένα
περιβάλλον επεξεργασίας εγγράφων για δημοσίευση.</figcaption>
</figure>
