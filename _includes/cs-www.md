...
<figure id="fig:www">
{% include figure image_path="/images/www.png" caption=""
alt="Παγκόσμιος ιστός" %}
<figcaption>
...
{% include figure image_path="/images/amaya-web-editor.jpg" caption=""
alt="Επεξεργασία ιστοσελίδων" %}
<figcaption>
