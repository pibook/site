...
<figure id="fig:Seikodata2000">
{% include figure image_path="/images/smartwatch.jpg" caption=""
alt="smartwatch" %}
<figcaption>
Τα δεδομένα συγχρονίστηκαν από το πληκτρολόγιο στο ρολόι μέσω ηλεκτρομαγνητικής ζεύξης (ασύρματη σύνδεση). Η μνήμη του ήταν μικρή, με μόνο 112 ψηφία. Κυκλοφόρησε το 1984, σε χρυσό, ασημί και μαύρο.[^1]
