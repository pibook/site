...
9. If you want to add a new case study you must create a new md file in the _case_study folder using the same format as the existnig files. At the end of that file you must have a link to an md file that should be in the _includes folder that conatains the main body of the case study.
